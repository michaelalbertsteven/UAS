...
$error = '';
$validate = '';
if( isset($_SESSION['user']) ) header('Location: adminRegister.php');
...
if( isset($_POST['submit']) ){
        ...
        if(!empty(trim($name)) && !empty(trim($username)) && !empty(trim($email)) && !empty(trim($password)) && !empty(trim($repass))){
            ...
            if($password == $repass){
                ...
                if( cek_nama($username,$con) == 0 ){
                    ...
                    $query = "INSERT INTO adminuser (username,name,email, password, repassword ) VALUES ('$username','$name','$email','$pass', '$repass')";
    ...
    function cek_nama($username,$con){
        ...
        $query = "SELECT * FROM adminuser WHERE username = '$nama'";
...
<body class="background-img">
    <div class="header"><h1>WELCOME TO ADMIN REGISTER PAGE</h1></div>
    <div class="content">
        <div class="cards">
            <div class="card">
